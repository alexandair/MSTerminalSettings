// Generated at https://app.quicktype.io?share=mQ8CqJVxNhAV654UxtE0 on 2020-04-15
// <auto-generated />
//
...
namespace WindowsTerminal
{
    ...
    /// <summary>Properties that affect the entire window, regardless of the profile settings.</summary>
    public partial class TerminalSettingsClass
    {
        [J("alwaysShowTabs", NullValueHandling = N.Ignore)]              public bool? AlwaysShowTabs { get; set; }              // When set to true, tabs are always displayed. When set to false and showTabsInTitlebar is; set to false, tabs only appear after opening a new tab.
        [J("confirmCloseAllTabs", NullValueHandling = N.Ignore)]         public bool? ConfirmCloseAllTabs { get; set; }         // When set to `true` closing a window with multiple tabs open WILL require confirmation.; When set to `false` closing a window with multiple tabs open WILL NOT require; confirmation.
        [J("copyOnSelect", NullValueHandling = N.Ignore)]                public bool? CopyOnSelect { get; set; }                // When set to true, a selection is immediately copied to your clipboard upon creation. When; set to false, the selection persists and awaits further action.
        [J("defaultProfile", NullValueHandling = N.Ignore)]              public string DefaultProfile { get; set; }             // Sets the default profile. Opens by clicking the '+' icon or typing the key binding; assigned to 'newTab'. The guid of the desired default profile is used as the value.
        [J("initialCols", NullValueHandling = N.Ignore)]                 public long? InitialCols { get; set; }                 // The number of columns displayed in the window upon first load.
        [J("initialPosition", NullValueHandling = N.Ignore)]             public string InitialPosition { get; set; }            // The position of the top left corner of the window upon first load. On a system with; multiple displays, these coordinates are relative to the top left of the primary display.; If launchMode is set to maximized, the window will be maximized on the monitor specified; by those coordinates.
        [J("initialRows", NullValueHandling = N.Ignore)]                 public long? InitialRows { get; set; }                 // The number of rows displayed in the window upon first load.
        [J("keybindings", NullValueHandling = N.Ignore)]                 public List<Keybinding> Keybindings { get; set; }      // Properties are specific to each custom key binding.
        [J("launchMode", NullValueHandling = N.Ignore)]                  public LaunchMode? LaunchMode { get; set; }            // Defines whether the Terminal will launch as maximized or not.
        [J("requestedTheme", NullValueHandling = N.Ignore)]              public RequestedTheme? RequestedTheme { get; set; }    // Sets the theme of the application.
        [J("rowsToScroll", NullValueHandling = N.Ignore)]                public RowsToScroll? RowsToScroll { get; set; }        // The number of rows to scroll at a time with the mouse wheel. This will override the; system setting if the value is not zero or 'system'.
        [J("showTabsInTitlebar", NullValueHandling = N.Ignore)]          public bool? ShowTabsInTitlebar { get; set; }          // When set to true, the tabs are moved into the titlebar and the titlebar disappears. When; set to false, the titlebar sits above the tabs.
        [J("showTerminalTitleInTitlebar", NullValueHandling = N.Ignore)] public bool? ShowTerminalTitleInTitlebar { get; set; } // When set to true, titlebar displays the title of the selected tab. When set to false,; titlebar displays 'Windows Terminal'.
        [J("snapToGridOnResize", NullValueHandling = N.Ignore)]          public bool? SnapToGridOnResize { get; set; }          // When set to true, the window will snap to the nearest character boundary on resize. When; false, the window will resize 'smoothly'
        [J("tabWidthMode", NullValueHandling = N.Ignore)]                public TabWidthMode? TabWidthMode { get; set; }        // Sets the width of the tabs.
        [J("wordDelimiters", NullValueHandling = N.Ignore)]              public string WordDelimiters { get; set; }             // Determines the delimiters used in a double click selection.
        [J("profiles")]                                                  public Profiles Profiles { get; set; }
        [J("schemes")]                                                   public List<SchemeList> Schemes { get; set; }
        [J("globals", NullValueHandling = N.Ignore)]                     public Globals Globals { get; set; }
    }
    ...
    public partial class Globals
    {
        ...
        [J("confirmCloseAllTabs", NullValueHandling = N.Ignore)]         public bool? ConfirmCloseAllTabs { get; set; }         // When set to `true` closing a window with multiple tabs open WILL require confirmation.; When set to `false` closing a window with multiple tabs open WILL NOT require; confirmation.
        [J("copyOnSelect", NullValueHandling = N.Ignore)]                public bool? CopyOnSelect { get; set; }                // When set to true, a selection is immediately copied to your clipboard upon creation. When; set to false, the selection persists and awaits further action.
        [J("defaultProfile")]                                            public string DefaultProfile { get; set; }             // Sets the default profile. Opens by clicking the '+' icon or typing the key binding; assigned to 'newTab'. The guid of the desired default profile is used as the value.
        [J("initialCols", NullValueHandling = N.Ignore)]                 public long? InitialCols { get; set; }                 // The number of columns displayed in the window upon first load.
        [J("initialPosition", NullValueHandling = N.Ignore)]             public string InitialPosition { get; set; }            // The position of the top left corner of the window upon first load. On a system with; multiple displays, these coordinates are relative to the top left of the primary display.; If launchMode is set to maximized, the window will be maximized on the monitor specified; by those coordinates.
        [J("initialRows", NullValueHandling = N.Ignore)]                 public long? InitialRows { get; set; }                 // The number of rows displayed in the window upon first load.
        [J("keybindings", NullValueHandling = N.Ignore)]                 public List<Keybinding> Keybindings { get; set; }      // Properties are specific to each custom key binding.
    ...
    {
        [J("command")] public Command Command { get; set; } // The action executed when the associated key bindings are pressed.
        [J("keys")]    public Keys Keys { get; set; }       // Defines the key combinations used to call the command.
    }

    /// <summary>Arguments corresponding to a Copy Text Action; ; Arguments corresponding to a New Tab Action; ; Arguments corresponding to a Switch To Tab Action; ; Arguments corresponding to a Move Focus Action; ; Arguments corresponding to a Resize Pane Action; ; Arguments corresponding to a Split Pane Action</summary>
    public partial class Action
    {
        [J("action")]                                          public ActionEnum ActionAction { get; set; }  // The action to execute
        [J("trimWhitespace", NullValueHandling = N.Ignore)]    public bool? TrimWhitespace { get; set; }     // If true, whitespace is removed and newlines are maintained. If false, newlines are; removed and whitespace is maintained.
        [J("commandline", NullValueHandling = N.Ignore)]       public string Commandline { get; set; }       // A commandline to use instead of the profile's
        [J("index", NullValueHandling = N.Ignore)]             public long? Index { get; set; }              // The index of the profile in the new tab dropdown to open; ; Which tab to switch to, with the first being 0
        [J("profile", NullValueHandling = N.Ignore)]           public string Profile { get; set; }           // Either the GUID or name of a profile to use, instead of launching the default
        [J("startingDirectory", NullValueHandling = N.Ignore)] public string StartingDirectory { get; set; } // A startingDirectory to use instead of the profile's
        [J("tabTitle", NullValueHandling = N.Ignore)]          public string TabTitle { get; set; }          // An initial tabTitle to use instead of the profile's
        [J("direction", NullValueHandling = N.Ignore)]         public Direction? Direction { get; set; }     // The direction to move focus in, between panes; ; The direction to move the pane separator in
        [J("split", NullValueHandling = N.Ignore)]             public SplitState? Split { get; set; }        // The orientation to split the pane in, either vertical (think [|]), horizontal (think; [-]), or auto (splits pane based on remaining space)
    }

    /// <summary>A list of profiles and the properties specific to each.; ; Properties specific to a unique profile.; ; The default settings that apply to every profile.</summary>
    public partial class ProfileList
    {
        [J("guid")]                                                                                                   public string Guid { get; set; }                                            // Unique identifier of the profile. Written in registry format:; "{00000000-0000-0000-0000-000000000000}".
        [J("name")][JsonConverter(typeof(MinMaxLengthCheckConverter))]                                                public string Name { get; set; }                                            // Name of the profile. Displays in the dropdown menu.
        [J("acrylicOpacity", NullValueHandling = N.Ignore)][JsonConverter(typeof(MinMaxValueCheckConverter))]         public double? AcrylicOpacity { get; set; }                                 // When useAcrylic is set to true, it sets the transparency of the window for the profile.; Accepts floating point values from 0-1 (default 0.5).
        [J("antialiasingMode", NullValueHandling = N.Ignore)]                                                         public AntialiasingMode? AntialiasingMode { get; set; }                     // Controls how text is antialiased in the renderer. Possible values are "grayscale",; "cleartype" and "aliased". Note that changing this setting will require starting a new; terminal instance.
        [J("background", NullValueHandling = N.Ignore)]                                                               public string Background { get; set; }                                      // Sets the background color of the profile. Overrides background set in color scheme if; colorscheme is set. Uses hex color format: "#rrggbb".
        [J("backgroundImage", NullValueHandling = N.Ignore)]                                                          public string BackgroundImage { get; set; }                                 // Sets the file location of the Image to draw over the window background.
        [J("backgroundImageAlignment", NullValueHandling = N.Ignore)]                                                 public BackgroundImageAlignment? BackgroundImageAlignment { get; set; }
        [J("backgroundImageOpacity", NullValueHandling = N.Ignore)][JsonConverter(typeof(MinMaxValueCheckConverter))] public double? BackgroundImageOpacity { get; set; }                         // (Not in SettingsSchema.md)
        [J("backgroundImageStretchMode", NullValueHandling = N.Ignore)]                                               public BackgroundImageStretchMode? BackgroundImageStretchMode { get; set; } // Sets how the background image is resized to fill the window.
        [J("closeOnExit", NullValueHandling = N.Ignore)]                                                              public CloseOnExitUnion? CloseOnExit { get; set; }                          // Sets how the profile reacts to termination or failure to launch. Possible values:; "graceful" (close when exit is typed or the process exits normally), "always" (always; close) and "never" (never close). true and false are accepted as synonyms for "graceful"; and "never" respectively.
        [J("colorScheme", NullValueHandling = N.Ignore)]                                                              public string ColorScheme { get; set; }                                     // Name of the terminal color scheme to use. Color schemes are defined under "schemes".
        [J("colorTable", NullValueHandling = N.Ignore)]                                                               public List<ColorTable> ColorTable { get; set; }                            // Array of colors used in the profile if colorscheme is not set. Colors use hex color; format: "#rrggbb". Ordering is as follows: [black, red, green, yellow, blue, magenta,; cyan, white, bright black, bright red, bright green, bright yellow, bright blue, bright; magenta, bright cyan, bright white]
        [J("commandline", NullValueHandling = N.Ignore)]                                                              public string Commandline { get; set; }                                     // Executable used in the profile.
        [J("connectionType", NullValueHandling = N.Ignore)]                                                           public string ConnectionType { get; set; }                                  // A GUID reference to a connection type. Currently undocumented as of 0.3, this is used for; Azure Cloud Shell
        [J("cursorColor", NullValueHandling = N.Ignore)]                                                              public string CursorColor { get; set; }                                     // Sets the cursor color for the profile. Uses hex color format: "#rrggbb".
        [J("cursorHeight", NullValueHandling = N.Ignore)]                                                             public long? CursorHeight { get; set; }                                     // Sets the percentage height of the cursor starting from the bottom. Only works when; cursorShape is set to "vintage". Accepts values from 25-100.
        [J("cursorShape", NullValueHandling = N.Ignore)]                                                              public CursorShape? CursorShape { get; set; }                               // Sets the cursor shape for the profile. Possible values: "vintage" ( ▃ ), "bar" ( ┃,; default ), "underscore" ( ▁ ), "filledBox" ( █ ), "emptyBox" ( ▯ )
        [J("experimental.retroTerminalEffect", NullValueHandling = N.Ignore)]                                         public bool? ExperimentalRetroTerminalEffect { get; set; }                  // When set to true, enable retro terminal effects. This is an experimental feature, and its; continued existence is not guaranteed.
        [J("fontFace", NullValueHandling = N.Ignore)]                                                                 public string FontFace { get; set; }                                        // Name of the font face used in the profile.
        [J("fontSize", NullValueHandling = N.Ignore)]                                                                 public long? FontSize { get; set; }                                         // Sets the font size.
        [J("foreground", NullValueHandling = N.Ignore)]                                                               public string Foreground { get; set; }                                      // Sets the foreground color of the profile. Overrides foreground set in color scheme if; colorscheme is set. Uses hex color format: "#rrggbb".
        [J("hidden", NullValueHandling = N.Ignore)]                                                                   public bool? Hidden { get; set; }                                           // If set to true, the profile will not appear in the list of profiles. This can be used to; hide default profiles and dynamically generated profiles, while leaving them in your; settings file.
        [J("historySize", NullValueHandling = N.Ignore)]                                                              public long? HistorySize { get; set; }                                      // The number of lines above the ones displayed in the window you can scroll back to.
        [J("icon", NullValueHandling = N.Ignore)]                                                                     public string Icon { get; set; }                                            // Image file location of the icon used in the profile. Displays within the tab and the; dropdown menu.
        [J("padding", NullValueHandling = N.Ignore)]                                                                  public string Padding { get; set; }                                         // Sets the padding around the text within the window. Can have three different formats: "#"; sets the same padding for all sides, "#, #" sets the same padding for left-right and; top-bottom, and "#, #, #, #" sets the padding individually for left, top, right, and; bottom.
        [J("scrollbarState", NullValueHandling = N.Ignore)]                                                           public ScrollbarState? ScrollbarState { get; set; }                         // Defines the visibility of the scrollbar.
        [J("selectionBackground", NullValueHandling = N.Ignore)]                                                      public string SelectionBackground { get; set; }                             // Sets the selection background color of the profile. Overrides selection background set in; color scheme if colorscheme is set. Uses hex color format: "#rrggbb".
        [J("snapOnInput", NullValueHandling = N.Ignore)]                                                              public bool? SnapOnInput { get; set; }                                      // When set to true, the window will scroll to the command input line when typing. When set; to false, the window will not scroll when you start typing.
        [J("source", NullValueHandling = N.Ignore)]                                                                   public string Source { get; set; }                                          // Stores the name of the profile generator that originated this profile.
        [J("startingDirectory", NullValueHandling = N.Ignore)]                                                        public string StartingDirectory { get; set; }                               // The directory the shell starts in when it is loaded.
        [J("suppressApplicationTitle", NullValueHandling = N.Ignore)]                                                 public bool? SuppressApplicationTitle { get; set; }                         // When set to true, tabTitle overrides the default title of the tab and any title change; messages from the application will be suppressed. When set to false, tabTitle behaves as; normal.
        [J("tabTitle", NullValueHandling = N.Ignore)]                                                                 public string TabTitle { get; set; }                                        // If set, will replace the name as the title to pass to the shell on startup. Some shells; (like bash) may choose to ignore this initial value, while others (cmd, powershell) may; use this value over the lifetime of the application.
        [J("useAcrylic", NullValueHandling = N.Ignore)]                                                               public bool? UseAcrylic { get; set; }                                       // When set to true, the window will have an acrylic background. When set to false, the; window will have a plain, untextured background.
    }

    public partial class ColorTable
    {
        [J("background", NullValueHandling = N.Ignore)]   public string Background { get; set; }   // Sets the background color of the color table.
        [J("black", NullValueHandling = N.Ignore)]        public string Black { get; set; }        // Sets the color used as ANSI black.
        [J("blue", NullValueHandling = N.Ignore)]         public string Blue { get; set; }         // Sets the color used as ANSI blue.
        [J("brightBlack", NullValueHandling = N.Ignore)]  public string BrightBlack { get; set; }  // Sets the color used as ANSI bright black.
        [J("brightBlue", NullValueHandling = N.Ignore)]   public string BrightBlue { get; set; }   // Sets the color used as ANSI bright blue.
        [J("brightCyan", NullValueHandling = N.Ignore)]   public string BrightCyan { get; set; }   // Sets the color used as ANSI bright cyan.
        [J("brightGreen", NullValueHandling = N.Ignore)]  public string BrightGreen { get; set; }  // Sets the color used as ANSI bright green.
        [J("brightPurple", NullValueHandling = N.Ignore)] public string BrightPurple { get; set; } // Sets the color used as ANSI bright purple.
        [J("brightRed", NullValueHandling = N.Ignore)]    public string BrightRed { get; set; }    // Sets the color used as ANSI bright red.
        [J("brightWhite", NullValueHandling = N.Ignore)]  public string BrightWhite { get; set; }  // Sets the color used as ANSI bright white.
        [J("brightYellow", NullValueHandling = N.Ignore)] public string BrightYellow { get; set; } // Sets the color used as ANSI bright yellow.
        [J("cyan", NullValueHandling = N.Ignore)]         public string Cyan { get; set; }         // Sets the color used as ANSI cyan.
        [J("foreground", NullValueHandling = N.Ignore)]   public string Foreground { get; set; }   // Sets the foreground color of the color table.
        [J("green", NullValueHandling = N.Ignore)]        public string Green { get; set; }        // Sets the color used as ANSI green.
        [J("purple", NullValueHandling = N.Ignore)]       public string Purple { get; set; }       // Sets the color used as ANSI purple.
        [J("red", NullValueHandling = N.Ignore)]          public string Red { get; set; }          // Sets the color used as ANSI red.
        [J("white", NullValueHandling = N.Ignore)]        public string White { get; set; }        // Sets the color used as ANSI white.
        [J("yellow", NullValueHandling = N.Ignore)]       public string Yellow { get; set; }       // Sets the color used as ANSI yellow.
    }

    /// <summary>A list of profiles and default settings that apply to all of them</summary>
    public partial class ProfilesObject
    {
        [J("defaults", NullValueHandling = N.Ignore)] public Profile Defaults { get; set; }       // The default settings that apply to every profile.
        [J("list", NullValueHandling = N.Ignore)]     public List<ProfileList> List { get; set; }
    }
    ...
    public partial class Profile
    {
        ...
        [J("fontSize", NullValueHandling = N.Ignore)]                                                                 public long? FontSize { get; set; }                                         // Sets the font size.
        [J("foreground", NullValueHandling = N.Ignore)]                                                               public string Foreground { get; set; }                                      // Sets the foreground color of the profile. Overrides foreground set in color scheme if; colorscheme is set. Uses hex color format: "#rrggbb".
        [J("guid", NullValueHandling = N.Ignore)]                                                                     public string Guid { get; set; }                                            // Unique identifier of the profile. Written in registry format:; "{00000000-0000-0000-0000-000000000000}".
        [J("hidden", NullValueHandling = N.Ignore)]                                                                   public bool? Hidden { get; set; }                                           // If set to true, the profile will not appear in the list of profiles. This can be used to; hide default profiles and dynamically generated profiles, while leaving them in your; settings file.
        [J("historySize", NullValueHandling = N.Ignore)]                                                              public long? HistorySize { get; set; }                                      // The number of lines above the ones displayed in the window you can scroll back to.
        [J("icon", NullValueHandling = N.Ignore)]                                                                     public string Icon { get; set; }                                            // Image file location of the icon used in the profile. Displays within the tab and the; dropdown menu.
        [J("name", NullValueHandling = N.Ignore)][JsonConverter(typeof(MinMaxLengthCheckConverter))]                  public string Name { get; set; }                                            // Name of the profile. Displays in the dropdown menu.
        [J("padding", NullValueHandling = N.Ignore)]                                                                  public string Padding { get; set; }                                         // Sets the padding around the text within the window. Can have three different formats: "#"; sets the same padding for all sides, "#, #" sets the same padding for left-right and; top-bottom, and "#, #, #, #" sets the padding individually for left, top, right, and; bottom.
        [J("scrollbarState", NullValueHandling = N.Ignore)]                                                           public ScrollbarState? ScrollbarState { get; set; }                         // Defines the visibility of the scrollbar.
        [J("selectionBackground", NullValueHandling = N.Ignore)]                                                      public string SelectionBackground { get; set; }                             // Sets the selection background color of the profile. Overrides selection background set in; color scheme if colorscheme is set. Uses hex color format: "#rrggbb".
        [J("snapOnInput", NullValueHandling = N.Ignore)]                                                              public bool? SnapOnInput { get; set; }                                      // When set to true, the window will scroll to the command input line when typing. When set; to false, the window will not scroll when you start typing.
    ...
    /// <summary>Properties are specific to each color scheme. ColorTool is a great tool you can use to; create and explore new color schemes. All colors use hex color format.</summary>
    public partial class SchemeList
    {
        [J("background", NullValueHandling = N.Ignore)]                                              public string Background { get; set; }          // Sets the background color of the color scheme.
        [J("black", NullValueHandling = N.Ignore)]                                                   public string Black { get; set; }               // Sets the color used as ANSI black.
        [J("blue", NullValueHandling = N.Ignore)]                                                    public string Blue { get; set; }                // Sets the color used as ANSI blue.
        [J("brightBlack", NullValueHandling = N.Ignore)]                                             public string BrightBlack { get; set; }         // Sets the color used as ANSI bright black.
        [J("brightBlue", NullValueHandling = N.Ignore)]                                              public string BrightBlue { get; set; }          // Sets the color used as ANSI bright blue.
        ...
        [J("brightYellow", NullValueHandling = N.Ignore)]                                            public string BrightYellow { get; set; }        // Sets the color used as ANSI bright yellow.
        [J("cyan", NullValueHandling = N.Ignore)]                                                    public string Cyan { get; set; }                // Sets the color used as ANSI cyan.
        [J("foreground", NullValueHandling = N.Ignore)]                                              public string Foreground { get; set; }          // Sets the foreground color of the color scheme.
        [J("green", NullValueHandling = N.Ignore)]                                                   public string Green { get; set; }               // Sets the color used as ANSI green.
        [J("name", NullValueHandling = N.Ignore)][JsonConverter(typeof(MinMaxLengthCheckConverter))] public string Name { get; set; }                // Name of the color scheme.
        [J("purple", NullValueHandling = N.Ignore)]                                                  public string Purple { get; set; }              // Sets the color used as ANSI purple.
        [J("red", NullValueHandling = N.Ignore)]                                                     public string Red { get; set; }                 // Sets the color used as ANSI red.
        [J("selectionBackground", NullValueHandling = N.Ignore)]                                     public string SelectionBackground { get; set; } // Sets the selection background color of the color scheme.
        [J("white", NullValueHandling = N.Ignore)]                                                   public string White { get; set; }               // Sets the color used as ANSI white.
        [J("yellow", NullValueHandling = N.Ignore)]                                                  public string Yellow { get; set; }              // Sets the color used as ANSI yellow.
    }
    ...
    /// <summary>The direction to move focus in, between panes; ; The direction to move the pane separator in</summary>
    public enum Direction { Down, Left, Right, Up };

    /// <summary>The orientation to split the pane in, either vertical (think [|]), horizontal (think; [-]), or auto (splits pane based on remaining space)</summary>
    public enum SplitState { Auto, Horizontal, Vertical };

    /// <summary>Defines whether the Terminal will launch as maximized or not.</summary>
    ...
    /// <summary>Sets the width of the tabs.</summary>
    public enum TabWidthMode { Equal, TitleLength };

    /// <summary>Controls how text is antialiased in the renderer. Possible values are "grayscale",; "cleartype" and "aliased". Note that changing this setting will require starting a new; terminal instance.</summary>
    ...
    /// <summary>Sets how the background image is resized to fill the window.</summary>
    public enum BackgroundImageStretchMode { Fill, None, Uniform, UniformToFill };

    public enum CloseOnExitEnum { Always, Graceful, Never };

    /// <summary>Sets the cursor shape for the profile. Possible values: "vintage" ( ▃ ), "bar" ( ┃,; default ), "underscore" ( ▁ ), "filledBox" ( █ ), "emptyBox" ( ▯ )</summary>
    public enum CursorShape { Bar, EmptyBox, FilledBox, Underscore, Vintage };

    /// <summary>Defines the visibility of the scrollbar.</summary>
    public enum ScrollbarState { Hidden, Visible };

    /// <summary>The action executed when the associated key bindings are pressed.</summary>
    ...
    /// <summary>Defines the key combinations used to call the command.</summary>
    ...
    /// <summary>The number of rows to scroll at a time with the mouse wheel. This will override the; system setting if the value is not zero or 'system'.</summary>
    ...
    /// <summary>Sets how the profile reacts to termination or failure to launch. Possible values:; "graceful" (close when exit is typed or the process exits normally), "always" (always; close) and "never" (never close). true and false are accepted as synonyms for "graceful"; and "never" respectively.</summary>
    ...
    public partial struct TerminalSettingsUnion
    {
        ...
        public long? Integer;
        public string String;
        public TerminalSettingsClass TerminalSettingsClass;

        public static implicit operator TerminalSettingsUnion(List<object> AnythingArray) => new TerminalSettingsUnion { AnythingArray = AnythingArray };
        public static implicit operator TerminalSettingsUnion(bool Bool) => new TerminalSettingsUnion { Bool = Bool };
        public static implicit operator TerminalSettingsUnion(double Double) => new TerminalSettingsUnion { Double = Double };
        public static implicit operator TerminalSettingsUnion(long Integer) => new TerminalSettingsUnion { Integer = Integer };
        public static implicit operator TerminalSettingsUnion(string String) => new TerminalSettingsUnion { String = String };
        public static implicit operator TerminalSettingsUnion(TerminalSettingsClass TerminalSettingsClass) => new TerminalSettingsUnion { TerminalSettingsClass = TerminalSettingsClass };
        public bool IsNull => AnythingArray == null && Bool == null && TerminalSettingsClass == null && Double == null && Integer == null && String == null;
    }

    public class TerminalSettings
    {
        public static object FromJson(string json) => JsonConvert.DeserializeObject<object>(json, WindowsTerminal.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this object self) => JsonConvert.SerializeObject(self, WindowsTerminal.Converter.Settings);
    }
    ...
    internal static class Converter
    {
        public static readonly JsonSerializerSettings Settings = new JsonSerializerSettings
        {
            ...
            Converters =
            {
                TerminalSettingsUnionConverter.Singleton,
    ...
    internal class TerminalSettingsUnionConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(TerminalSettingsUnion) || t == typeof(TerminalSettingsUnion?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case JsonToken.Null:
                    return new TerminalSettingsUnion { };
                case JsonToken.Integer:
                    var integerValue = serializer.Deserialize<long>(reader);
                    return new TerminalSettingsUnion { Integer = integerValue };
                case JsonToken.Float:
                    var doubleValue = serializer.Deserialize<double>(reader);
                    return new TerminalSettingsUnion { Double = doubleValue };
                case JsonToken.Boolean:
                    var boolValue = serializer.Deserialize<bool>(reader);
                    return new TerminalSettingsUnion { Bool = boolValue };
                case JsonToken.String:
                case JsonToken.Date:
                    var stringValue = serializer.Deserialize<string>(reader);
                    return new TerminalSettingsUnion { String = stringValue };
                case JsonToken.StartObject:
                    var objectValue = serializer.Deserialize<TerminalSettingsClass>(reader);
                    return new TerminalSettingsUnion { TerminalSettingsClass = objectValue };
                case JsonToken.StartArray:
                    var arrayValue = serializer.Deserialize<List<object>>(reader);
                    return new TerminalSettingsUnion { AnythingArray = arrayValue };
            }
            throw new Exception("Cannot unmarshal type TerminalSettingsUnion");
        }

        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            var value = (TerminalSettingsUnion)untypedValue;
            if (value.IsNull)
            {
            ...
            if (value.TerminalSettingsClass != null)
            {
                serializer.Serialize(writer, value.TerminalSettingsClass);
                return;
            }
            throw new Exception("Cannot marshal type TerminalSettingsUnion");
        }

        public static readonly TerminalSettingsUnionConverter Singleton = new TerminalSettingsUnionConverter();
    }
